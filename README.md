...
Раз в N секунд интеграция берёт кадр с включённой камеры, отправляет в DeepFace, проверяет на подделку и сравнивает лицо с эталонами. При совпадении выше порога — открывает привязанный замок, шлёт уведомление и обновляет сенсор.
