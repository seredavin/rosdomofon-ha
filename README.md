...
- **Настройки сервиса** — укажите URL DeepFace (`http://<адрес-сервера>:5000`), модель (по умолчанию `Facenet512`), порог сходства (меньше — строже), интервал опроса, паузу после открытия и включите антиспуфинг.
